...
- [Getting Started](/livekit-msteams-bridge/getting-started/) - install, prepare an agent, first call.
- [Connecting to StandIn](/livekit-msteams-bridge/connecting-to-standin/) - pair an identity and point it at your bridge.
- [Agents and Dispatch](/livekit-msteams-bridge/agents-and-dispatch/) - explicit dispatch, metadata, data topics, avatar agents.
- [Configuration Reference](/livekit-msteams-bridge/configuration-reference/) - every environment variable.
