...
Then run the bridge (see [`../basic-bridge`](../basic-bridge) or `npx @komaa/livekit-msteams-bridge`) with `LIVEKIT_AGENT_NAME=teams-voice-agent`, point a StandIn identity at it, and call your Teams bot.
