...
- **Video**: caller video/screenshare frames are not published into the room. Avatar-agent video is bridged to the Teams tile by default (`LIVEKIT_TILE_VIDEO=auto`); set `off` to disable.
